...
struct Color_t
{
	...
	Color_t lerp(Color_t& other, float step)
	{
		Color_t lerped_color{
			static_cast<int>(std::lerp(r, other.r, step)),
			static_cast<int>(std::lerp(g, other.g, step)),
			static_cast<int>(std::lerp(b, other.b, step)),
			static_cast<int>(std::lerp(a, other.a, step))
		};
