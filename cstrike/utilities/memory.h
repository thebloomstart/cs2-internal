...
namespace MEM
{
	...
	void SendMessageToLocalPlayer(const char* msg);
	...
	void*);
	inline void(CS_FASTCALL* fnDispatchEffect)(const char*, CEffectData*);
	inline unsigned int(CS_FASTCALL* GetHashSeed)(C_CSPlayerPawn*, QAngle_t, int);
}